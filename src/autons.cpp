...
void skills()
{
    ...
    chassis.moveToPoint(3, 55, 1300, {.maxSpeed = 90});
    chassis.turnToHeading(0, 600);
    chassis.moveToPoint(3, 73, 1200, {.maxSpeed = 80});
    chassis.waitUntil(5);
    fastintake.move_relative(-100, 600);
    arm.move_absolute(550, 200);
    chassis.cancelAllMotions();
    chassis.moveToPoint(3, chassis.getPose().y-2, 800,{.forwards=false});
    chassis.turnToHeading(0, 600);
    chassis.moveToPoint(3,70, 800, {.maxSpeed=80});
    ...
    chassis.moveToPoint(1, -55, 1300, {.maxSpeed = 90});
    chassis.turnToHeading(180, 600);
    chassis.moveToPoint(1, -73, 1200, {.maxSpeed = 80});
    chassis.waitUntil(5);
    fastintake.move_relative(-100, 600);
    arm.move_absolute(550, 200);
    chassis.cancelAllMotions();
    chassis.moveToPoint(1, chassis.getPose().y+3, 800,{.forwards=false});
    chassis.moveToPoint(1,-70, 800, {.maxSpeed=80});
    arm.move_relative(100,200);
    fastintake.move_voltage(10000);
    chassis.waitUntilDone();
    delay(50);
    ...
    chassis.moveToPoint(-47, -62, 900);
    chassis.turnToHeading(60, 700,{.maxSpeed=60});
    chassis.moveToPoint(-60, -60, 900, {.forwards = false});
    chassis.waitUntilDone();
    clamp.toggle();
    fastintake.move_relative(-700, 600);

...
void RLE()
{
    ...
    delay(50);
    chassis.moveToPose(-5, chassis.getPose().y + 3, 90, 1200, {.minSpeed = 40});
    doink.toggle();
...
void RRE()
{
    ...
    chassis.moveToPoint(-15.5,-48,1100);
    ...
    chassis.moveToPoint(-50,-12,800,{.forwards=false});
    fastintake.move_voltage(10000);
    doink.toggle();
    chassis.turnToHeading(-25,300);
    chassis.moveToPoint(-62, -3,  1000);
    doink.toggle();
    chassis.turnToPoint(-72,5,600);
    chassis.waitUntilDone();
    delay(1000);
...
void BLE() {
    ...
    intake.move_voltage(12000);
    arm.move_absolute(300,100);
    chassis.moveToPoint(15.5,-48,1200);
    ...
    doink.toggle();
    chassis.turnToPoint(72,0.5,600);
    chassis.waitUntilDone();
    delay(1000);
    fastintake.move_relative(-100,600);
    arm.move_absolute(550, 200);
...
void BRE()
{
    ...
    chassis.moveToPose(4, chassis.getPose().y + 5, -90, 1200, {.minSpeed = 40});
    doink.toggle();
...
void skills()
{
    ...
    chassis.moveToPoint(-55, -2, 1700, {.maxSpeed = 90, .minSpeed = 10});
    ...
    chassis.moveToPoint(52, 4, 1000, {.forwards = false, .maxSpeed = 80});
    ...
    chassis.cancelAllMotions();
    chassis.moveToPoint(5, 0, 1000, {.forwards = false, .maxSpeed = 70, .minSpeed = 40});
...
//     chassis.moveToPoint(-53, -26, 1000, {.forwards = false});
//     chassis.waitUntil(24);
//     chassis.cancelAllMotions();
//     chassis.moveToPoint(-53, -26, 800, {.forwards = false, .maxSpeed = 70});
...
//     chassis.turnToHeading(135, 600, {.maxSpeed = 70, .minSpeed = 10});
//     chassis.moveToPoint(0, -52, 1300, {.maxSpeed = 90, .minSpeed = 10});

//     chassis.turnToHeading(180, 600);
//     chassis.moveToPoint(0, -71, 600, {.maxSpeed = 80, .minSpeed = 10});
//     chassis.waitUntil(5);
//     fastintake.move_relative(-100, 600);
//     arm.move_absolute(500, 200);
//     chassis.cancelAllMotions();
...
//     chassis.moveToPoint(52, 3, 800, {.forwards = false, .maxSpeed = 90});

//     chassis.waitUntilDone();
//     clamp.toggle();
//     delay(50);
//     // chassis.swingToHeading(120,DriveSide::LEFT,900);
//     chassis.moveToPoint(65, -3, 1000, { .minSpeed = 30});
//     chassis.turnToHeading(90, 800, {.maxSpeed = 80});
...
//     delay(500);
//     chassis.turnToHeading(180, 800, {.minSpeed = 70});
//     chassis.waitUntilDone();
//     delay(700);
//     clamp.toggle();
//     fastintake.move_relative(-100, 600);
...
//     chassis.moveToPoint(44, 25, 1000, {.minSpeed = 60, .earlyExitRange = 4});
//     fastintake.move_voltage(5000);
//     chassis.moveToPoint(58, -3, 1000, {.minSpeed = 60, .earlyExitRange = 9});

//     chassis.moveToPoint(66, -63, 2500, {.maxSpeed = 110});
//     chassis.waitUntilDone();
//     chassis.swingToHeading(135, DriveSide::RIGHT, 800, {.minSpeed = 90});
//     chassis.moveToPoint(10, 0, 1200, {.forwards = false, .minSpeed = 40});
//     chassis.waitUntil(33);
//     chassis.cancelAllMotions();
//     chassis.moveToPoint(4, 0, 1000, {.forwards = false, .maxSpeed = 70, .minSpeed = 40});
...
void RWP()
{
    ...
    arm.move_absolute(600, 200);
    delay(300);
    chassis.moveToPoint(-24, 24, 1200, {.forwards = false, .maxSpeed = 90, .minSpeed = 30});
    arm.move_absolute(300, 100);
    chassis.waitUntilDone();
    clamp.toggle();
    delay(60);
    ...
    chassis.moveToPoint(-50, -27, 1000, {.maxSpeed = 90});
    clamp.toggle();
    fastintake.move_voltage(3000);
    chassis.turnToHeading(-90, 600, {.maxSpeed = 60});
    chassis.moveToPoint(-25, -26, 900, {.forwards = false});
    chassis.waitUntilDone();
    clamp.toggle();
    delay(50);
    chassis.moveToPoint(-24, -52, 1100, {.minSpeed = 50});
...
void BWP()
{
    ...
    arm.move_absolute(600, 200);
    delay(300);
    chassis.moveToPoint(24, 25, 1200, {.forwards = false, .maxSpeed = 90, .minSpeed = 30});
    arm.move_absolute(300, 100);
    chassis.waitUntilDone();
    clamp.toggle();
    delay(60);
    ...
    // chassis.setPose(chassis.getPose().x, 71.5 - x, chassis.getPose().theta);
    // delay(50);
    chassis.moveToPoint(9, 45, 1100);
    chassis.moveToPoint(50, 17, 1600, {.forwards = false,.maxSpeed=80, .minSpeed = 10});
    chassis.turnToHeading(180, 700, {.maxSpeed = 70, .minSpeed = 30});
    chassis.moveToPoint(50, -32, 1000, {.maxSpeed = 90});
    clamp.toggle();
    fastintake.move_voltage(4000);
    chassis.turnToHeading(90, 600, {.maxSpeed = 60});
    chassis.moveToPoint(23, -23, 900, {.forwards = false});
    chassis.waitUntilDone();
    clamp.toggle();
    delay(50);
